...
abstract class Tournament implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TournamentTableMap';
    ...
    /**
     * The value for the hostclub field.
     * @var        string
     */
    protected $hostclub;
    ...
    /**
     * Initializes internal state of Base\Tournament object.
     */
     ...
     *
     * @return $this|Tournament The current object, for fluid interface
     */
     ...
     * @return $this|\Tournament The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TournamentTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[TournamentTableMap::COL_NAME] = true;
        }
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->startdate !== null || $dt !== null) {
            if ($dt !== $this->startdate) {
                $this->startdate = $dt;
                $this->modifiedColumns[TournamentTableMap::COL_STARTDATE] = true;
            }
    ...
    public function setEndDate($v)
    {
        ...
        if ($this->enddate !== null || $dt !== null) {
            if ($dt !== $this->enddate) {
                $this->enddate = $dt;
                $this->modifiedColumns[TournamentTableMap::COL_ENDDATE] = true;
            }
        } // if either are not null
    ...
    /**
     * Set the value of [hostclub] column.
     *
     * @param  string $v new value
     * @return $this|\Tournament The current object (for fluent API support)
     */
    public function setHostClub($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->hostclub !== $v) {
            $this->hostclub = $v;
            $this->modifiedColumns[TournamentTableMap::COL_HOSTCLUB] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TournamentTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TournamentTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TournamentTableMap::translateFieldName('StartDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->startdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TournamentTableMap::translateFieldName('EndDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->enddate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TournamentTableMap::translateFieldName('HostClub', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hostclub = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = TournamentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Tournament'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TournamentTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TournamentTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(TournamentTableMap::COL_STARTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'startdate';
        }
        if ($this->isColumnModified(TournamentTableMap::COL_ENDDATE)) {
            $modifiedColumns[':p' . $index++]  = 'enddate';
        }
        if ($this->isColumnModified(TournamentTableMap::COL_HOSTCLUB)) {
            $modifiedColumns[':p' . $index++]  = 'hostClub';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'enddate':
                        ...
                        break;
                    case 'hostClub':
                        $stmt->bindValue($identifier, $this->hostclub, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TournamentTableMap::COL_ID)) {
            $criteria->add(TournamentTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TournamentTableMap::COL_NAME)) {
            $criteria->add(TournamentTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(TournamentTableMap::COL_STARTDATE)) {
            $criteria->add(TournamentTableMap::COL_STARTDATE, $this->startdate);
        }
        if ($this->isColumnModified(TournamentTableMap::COL_ENDDATE)) {
            $criteria->add(TournamentTableMap::COL_ENDDATE, $this->enddate);
        }
        if ($this->isColumnModified(TournamentTableMap::COL_HOSTCLUB)) {
            $criteria->add(TournamentTableMap::COL_HOSTCLUB, $this->hostclub);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setHostClub($this->getHostClub());
        if ($makeNew) {
            $copyObj->setNew(true);
